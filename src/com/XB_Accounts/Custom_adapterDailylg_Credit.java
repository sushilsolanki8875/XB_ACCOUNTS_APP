...
public class Custom_adapterDailylg_Credit extends BaseAdapter implements Filterable {
   ...
   public static Object_Account object;
	...
	public Custom_adapterDailylg_Credit(Context c,
		    	      ...
		    	      if(subGroup.accounts!=null){
			    	         for (Object_Account objAccount : subGroup.accounts) {
							        ...
							        TextView acName = new TextView(mContext);
							         ...
							         if(objAccount.accountTxn.isCash == 1){
							        	 cashAmount.setText(objAccount.accountTxn.amount+"");
							        	// cash = cash + objAccount.accountTxn.amount;
							         }else if(objAccount.accountTxn.isCash == 0){
							        	 transferAmount.setText(objAccount.accountTxn.amount+"");
							        	// transfer = transfer + objAccount.accountTxn.amount;
							         }
							         ...
							         //total = total + objAccount.accountTxn.amount;
							        	 ...
							        	 for(Object_Item objItem : objCat.items){
									         ...
									         linearItem.setOrientation(LinearLayout.HORIZONTAL);
							        		  ...
							        		  TextView txtItem = new TextView(mContext);
							        		   ...
							        		   txtItem.setText(objItem.itemTxn.qty+" "+objItem.unit.printName+" "+objItem.name);
